...
export default function RegistrationRequests() {
  ...
  async function openIdCard(request) {
    try {
      const result = await api.getRegistrationIdCardUrl(request.id);
